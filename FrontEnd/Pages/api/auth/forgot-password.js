// Proxy para redirigir solicitudes de recuperación de contraseña al backend
export default async function handler(req, res) {
    // Solo permitir POST para solicitud de recuperación de contraseña
    if (req.method !== 'POST') {
    ...
    try {
      ...
      console.log('API proxy: redirigiendo solicitud a', `${API_URL}/api/auth/forgot-password`);
